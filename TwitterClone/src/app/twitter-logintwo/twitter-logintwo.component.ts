...
@Component({
  selector: 'app-twitter-logintwo',
  templateUrl: './twitter-logintwo.component.html',
  styleUrls: ['./twitter-logintwo.component.css']
})
export class TwitterLogintwoComponent implements OnInit {
