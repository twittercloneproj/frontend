...
@Component({
  selector: 'app-post-tileprofile',
  templateUrl: './post-tileprofile.component.html',
  styleUrls: ['./post-tileprofile.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class PostTileprofileComponent implements OnInit {
